...
badd +1 db_vk.py
badd +120 db_all.py
badd +1 base_master/base_connection.py
badd +1 base_master/base_db.py
badd +1 settings.py
badd +1 load_vk.py
argglobal
silent! argdel *
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 37 - ((35 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 27 - ((25 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 120 - ((116 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
120
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 175 - ((171 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
175
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 404 - ((400 * winheight(0) + 35) / 71)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
404
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 154 - ((150 * winheight(0) + 35) / 71)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
154
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 25 - ((23 * winheight(0) + 35) / 71)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 165 - ((161 * winheight(0) + 35) / 71)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
165
