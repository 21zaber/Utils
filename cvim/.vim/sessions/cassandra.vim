...
silent only
cd ~/work/analytics/cassandra
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 schema_vk.cqlsh
badd +0 full_schema.cqlsh
badd +6 recreate1.sh
badd +0 recreate.sh
badd +7 schema_tw.cqlsh
badd +6 schema_feed.cqlsh
badd +1 recrete_full.sh
argglobal
silent! argdel *
set stal=2
edit schema_feed.cqlsh
...
exe 'vert 3resize ' . ((&columns * 30 + 136) / 272)
argglobal
setlocal keymap=
setlocal noarabic
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 76 - ((66 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 142 + 136) / 272)
exe 'vert 2resize ' . ((&columns * 129 + 136) / 272)
argglobal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
