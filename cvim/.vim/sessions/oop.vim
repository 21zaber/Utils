...
badd +14 Makefile
badd +34 lab1.cpp
badd +15 src/rectangle.cpp
badd +1 src/rectangle.h
badd +1 src/figure.cpp
badd +3 src/figure.h
badd +16 src/square.cpp
badd +18 src/trapezoid.cpp
badd +0 variant
badd +0 src/square.h
badd +0 src/trapezoid.h
argglobal
silent! argdel *
argadd Makefile
set stal=2
...
24
normal! zo
let s:l = 18 - ((17 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18
