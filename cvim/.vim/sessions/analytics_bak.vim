...
silent only
cd ~/work/analytics/backend/analytics
...
badd +0 db_vk.py
badd +0 db_all.py
badd +0 base_master/base_connection.py
badd +0 base_master/base_db.py
badd +0 settings.py
badd +0 load_vk.py
argglobal
silent! argdel *
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 27 - ((26 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 120 - ((119 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
120
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 175 - ((174 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
175
...
exe 'vert 1resize ' . ((&columns * 136 + 136) / 272)
exe 'vert 2resize ' . ((&columns * 135 + 136) / 272)
tabedit base_master/base_connection.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
404
normal! 01|
tabedit base_master/base_db.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 154 - ((153 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
154
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 165 - ((164 * winheight(0) + 36) / 73)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
165
